...
import com.brunocascio.cualferiado2.Services.FeriadosDB;
import com.brunocascio.cualferiado2.Services.SyncEvent;
    ...
    public static class FeriadoActualFragment extends Fragment {
        ...
        public void onEvent(SyncEvent event) {
            ...
            if (event.getType() == "update") {
                ...
                i.setAction("com.brunocascio.cualferiado2.W_UPDATE");
